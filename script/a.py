...
pag.press("enter")
time.sleep(网页加载时间)
pag.click(x=1075, y=245)
pag.typewrite(学号)
pag.click(x=1075, y=355)
ppc.copy(姓名)
pag.hotkey("ctrl", "v")
pag.click(x=1075, y=460)
ppc.copy(学院)
pag.hotkey("ctrl", "v")
pag.click(x=1075, y=570)
pag.typewrite(手机号码)
pag.click(x=1075, y=710)
pag.typewrite(预订日期)
if 预订时段:
    pag.click(x=1075, y=860)
    pag.scroll(-1000)
    pag.click(x=1075, y=390)
    pag.click(x=1075, y=455 + 25 * 周一至周五时段)
else:
    pag.click(x=1075, y=910)
    pag.scroll(-1000)
    pag.click(x=1075, y=390)
    pag.click(x=1075, y=600 + 25 * 周六周日时段)
pag.click(x=1075, y=740)
pag.click(x=1430, y=835)
